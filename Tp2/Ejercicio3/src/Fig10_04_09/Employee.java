...
public abstract class Employee {
	...
	private static final int additional = 300;
	...
	// Metodo que Calcula el sueldo de un empleado y si su mes de cumpleaños
	// conincide con el de la liquidacion se le otorga un adiccional a su sueldo
	public double salary(LocalDate date) {
		if (birthDate != null && date.getMonthValue() == birthDate.getMonthValue()) {
			System.out.println("Se le hizo el adiccional al sueldo!");
